...
To run it:
    ...
    $ docker run -d -e HOST_IP=${COREOS_PRIVATE_IPV4} -e ETCD_HOST=${COREOS_PRIVATE_IPV4}:4001 -v /var/run/docker.sock:/var/run/docker.sock 10.0.0.217:5000/docker-register:latest
